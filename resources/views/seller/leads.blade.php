                            ...
                            <tbody>
                                @foreach ($leads as $index => $lead)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('seller.leads.show', $lead->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="javascript:;" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger btn-sm" onclick="deleteDataId('{{ route('seller.leads.destroy', $lead->id) }}')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                  @endforeach
                            </tbody>
