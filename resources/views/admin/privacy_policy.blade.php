                            ...
                            <form action="{{ route('admin.privacy-policy.update',$privacyPolicy->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="privacy_policy" cols="30" rows="10" id="mytextarea">{!! $privacyPolicy->privacy_policy !!}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                        ...
                        @else
                            <form action="{{ route('admin.privacy-policy.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>{{__('admin.Privacy Policy')}}<span class="text-danger">*</span></label>
                                        <textarea name="privacy_policy" cols="30" rows="10" id="mytextarea"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
