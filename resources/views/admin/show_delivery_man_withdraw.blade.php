                  ...
                  <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <td width="50%">{{__('Delivery Man')}}</td>
                                <td width="50%"><a href="{{ route('admin.delivery-man.show',$withdraw->deliveryman->id) }}">{{ $withdraw->deliveryman->fname }} {{ $withdraw->deliveryman->lname }}</a></td>
                            </tr>
                            <tr>
